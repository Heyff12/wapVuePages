...
var info_list = {
    ...
    data: {
        base: {
            ...
            "status|1": [2, 3], //[1, 2, 3, 4] 用户状态 1:未绑定手机号 2:已绑定手机号，未激活 3:已绑定手机号并激活 4:已注销
            "role_type|1": [1, 3, 5, 8], //[1, 3, 5, 6, 7, 8] 角色类型 销售人员=1，门店管理人员=3，大区负责人=5，合作商=6，放款方=7，借款人=8
        ...
        "info|1-3": [{
            district_name: Random.cword(6, 33), // 大区名称
            "role_name|1": ["大区负责人", "门店管理人员", "销售人员"], // 角色名称
            store_name: Random.cword(6, 13), // 门店名称
